...
<div align="center">
	<font color="green"><b>Complaint registered successfully</b></font>
</div>
</div>
</body>
</html>
...
$comp = mysqli_real_escape_string($link, $_REQUEST['complain']);
$city = mysqli_real_escape_string($link, $_REQUEST['city']);
$ward = mysqli_real_escape_string($link, $_REQUEST['ward']);
// attempt insert query execution
$sql = "INSERT INTO complain (username,mob,email,city,ward,complain) VALUES ('$name', '$mobile', '$email','$city','$ward','$comp')";
